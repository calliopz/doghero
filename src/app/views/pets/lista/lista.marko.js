...
function render(input, out, __component, component, state) {
  ...
  out.w(" <a href=\"/pets\" class=\"pets\">Meus pets</a> <a href=\"/passeadores/lista\" class=\"passeador\">Heróis</a><a href=\"/passeios/lista\" class=\"passeio\">Passeios</a> </div></div></div></header><main class=\"conteudoPrincipal\"><div class=\"container\"><h3 clas=\"titulo\"> Meus pets <a href=\"/pets/form\"><img src=\"/estatico/img/add-button.png\" alt=\"adicionar pet\"></a></h3> <table id=\"pets\" class=\"table table-striped table-hover\"><thead class=\"thead-dark\"><tr><th>Nome</th><th>Espécie</th><th>Idade</th><th>Tamanho</th><th></th><th></th></tr></thead><tbody>");
  ...
  marko_forEach(data.pets, function(pet) {
    ...
    out.w("<tr" +
      ...
      "</td><td><a" +
      marko_attr("href", "/pets/form/" + pet.id) +
      ">Editar</a></td><td><a href=\"#\"" +
      marko_attr("data-ref", "" + pet.id) +
