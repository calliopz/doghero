...
var marko_template = module.exports = require("marko/src/html").t(__filename),
    marko_componentType = "/dogheron$1.0.0/src/app/views/usuarios/lista/lista.marko",
...
function render(input, out, __component, component, state) {
  ...
  out.w(" <a href=\"/pets\" class=\"pets\">Meus pets</a> <a href=\"/passeadores/lista\" class=\"passeador\">Heróis</a><a href=\"/passeios/lista\" class=\"passeio\">Passeios</a> </div></div></div></header><main class=\"conteudoPrincipal\"><div class=\"container\"><h1 class=\"info-pet\">Meus dados pessoais</h1>");
  ...
  out.w("<form action=\"/usuarios/form\" class=\"altera-cadastro\" method=\"get\">");

  if (data.usuario.id) {
    out.w("<div><input type=\"hidden\" name=\"_method\" value=\"PUT\"><input type=\"hidden\" id=\"id\" name=\"id\"" +
      marko_attr("value", "" + data.usuario.id) +
      "></div>");
  }

  out.w("<div><label for=\"nome\">Nome:</label><input type=\"text\" id=\"nome\" name=\"nome\"" +
    marko_attr("value", "" + data.usuario.nome_completo) +
    "></div><div><label for=\"email\">E-mail:</label><input type=\"text\" id=\"email\" name=\"email\"" +
    marko_attr("value", "" + data.usuario.email) +
    "></div><div><label for=\"senha\">Senha:</label><input type=\"password\" id=\"senha\" name=\"senha\"" +
...
marko_template.meta = {
    id: "/dogheron$1.0.0/src/app/views/usuarios/lista/lista.marko",
    tags: [
